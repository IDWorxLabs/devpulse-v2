...
Generated: 2026-06-23T21:20:47.319Z
...
## Performance Reality
- Load time analysis: launch=953ms shell=2537ms nav=79ms
- Interaction analysis: Navigation 79ms; build Build succeeded (168635 bytes)
- Runtime health: 0 errors, 0 warnings
- Build analysis: Build succeeded (168635 bytes)
...
- [x] **Build output artifacts generated** (build): 168635 bytes in dist/
- [x] **Bundle output size within reasonable bounds** (performance): 168635 bytes total build output
...
- [x] **Application loads within reasonable time** (performance): Launch screen visible in 953ms
...
- [x] **Auth and onboarding transition responsive** (performance): Reached app shell in 2537ms
...
- [x] **Route navigation remains responsive** (performance): Home → core feature in 79ms
