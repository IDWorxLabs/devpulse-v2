...
Generated: 2026-06-23T21:19:58.869Z
...
## Performance Reality
- Load time analysis: launch=945ms shell=2529ms nav=86ms
- Interaction analysis: Navigation 86ms; build Build succeeded (168568 bytes)
- Runtime health: 0 errors, 0 warnings
- Build analysis: Build succeeded (168568 bytes)
...
- [x] **Build output artifacts generated** (build): 168568 bytes in dist/
- [x] **Bundle output size within reasonable bounds** (performance): 168568 bytes total build output
...
- [x] **Application loads within reasonable time** (performance): Launch screen visible in 945ms
...
- [x] **Auth and onboarding transition responsive** (performance): Reached app shell in 2529ms
...
- [x] **Route navigation remains responsive** (performance): Home → core feature in 86ms
