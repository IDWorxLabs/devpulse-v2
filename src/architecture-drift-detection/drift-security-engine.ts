/**
 * Drift security engine — security assertions for drift detection.
...
export function assertNoAutoFixCapability(obj: object): boolean {
  return (
    typeof (obj as { autoFixDrift?: unknown }).autoFixDrift === 'undefined' &&
    typeof (obj as { repairArchitecture?: unknown }).repairArchitecture === 'undefined' &&
