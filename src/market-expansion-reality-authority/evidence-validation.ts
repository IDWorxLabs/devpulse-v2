/**
 * Shared evidence validation helpers for market expansion analyzers.
 */

import { FABRICATED_EVIDENCE_SOURCES } from './market-expansion-reality-registry.js';
import type { ObservedEvidenceBase } from './market-expansion-reality-types.js';
...
export function blockedByUpstreamOnlySignals(input: {
  ...
  return Boolean(input.revenueOnly || input.adoptionOnly || input.scaleReadinessOnly);
}
