...
export const ORCHESTRATION_FLOW = [
  ...
  'Assess Connected Build Execution Materialization',
  'Assess Connected Runtime Activation Proof',
  'Assess Connected Preview Experience Proof',
  'Assess Connected Verification Execution Proof',
