...
export type ContextNeed =
  ...
  | 'CROSS_DEVICE_RUNTIME_FOUNDATION_FACTS'
  | 'FOUNDER_NOTIFICATION_RUNTIME_FOUNDATION_FACTS'
  | 'FOUNDER_INBOX_FOUNDATION_FACTS'
  | 'NOTIFICATION_DELIVERY_FOUNDATION_FACTS'
  | 'BUILD_STRATEGY_ENGINE_FACTS'
  | 'AUTONOMOUS_BUILDER_FOUNDATION_FACTS'
  | 'MOBILE_PUSH_FOUNDATION_FACTS';
