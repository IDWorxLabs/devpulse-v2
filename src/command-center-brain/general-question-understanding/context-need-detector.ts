...
const QUESTION_CONTEXT_SIGNALS: Array<[readonly string[], ContextNeed]> = [
  ...
  [['what verification passed', 'what verification failed', 'what evidence exists', 'what visual issues exist', 'what interaction outcomes were verified', 'visual verification', 'verification results', 'verification evidence', 'verification risks', 'verification ready', 'verification failed', 'layout verification', 'navigation verification', 'loading verification', 'responsive verification'], 'VISUAL_VERIFICATION_ENGINE_FACTS'],
