/**
 * AIDEVENGINE_BUILD_PROOF_V1_3 — launch evidence handoff with bounded visual/runtime proof.
 */
...
export function applyLaunchEvidenceHandoffV13(input: {
  ...
  const { bundle, visualRuntime } = input;
  ...
  entries.push({
    ...
    fieldsUsed: [
      ...
      'enriched CQI via getLastCqiMaturityAssessment',
      'registered visual/feature assessments',
    ],
