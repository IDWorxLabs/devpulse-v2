/**
 * World 2 builder governance bridge — connects to workspace, planner, simulation, Phase 6 stack.
 * Dry-run foundation only. No governance bypass.
 */
...
export function assertNoRegistryRuntimeMutation(): boolean {
  const registry = getDevPulseV2Owner('world2_autonomous_builder');
  return registry.ownerModule === 'devpulse_v2_world2_autonomous_builder' && registry.phase === 7.4;
}

export function getBuilderGovernanceSummary(): string {
