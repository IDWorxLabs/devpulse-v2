...
const PROFILE_RULES: ProfileRuleSet[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      { term: 'stock', weight: 7 },
      { term: 'supplier', weight: 7 },
      { term: 'reorder', weight: 8 },
      { term: 'products', weight: 6 },
    ],
  },
  {
    profile: 'BOOKING_WEB_V1',
    intentLabel: 'booking and scheduling',
    keywords: [
      { term: 'booking system', weight: 12 },
      { term: 'appointment', weight: 11 },
      { term: 'appointments', weight: 11 },
      { term: 'schedule', weight: 9 },
      { term: 'calendar', weight: 8 },
      { term: 'availability', weight: 8 },
      { term: 'reservation', weight: 9 },
    ],
  },
  {
    profile: 'HABIT_TRACKER_WEB_V1',
    intentLabel: 'habit tracking',
    keywords: [
      { term: 'habit tracker', weight: 12 },
      { term: 'daily routine', weight: 11 },
      { term: 'daily routines', weight: 11 },
      { term: 'streak', weight: 10 },
