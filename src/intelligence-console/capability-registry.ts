...
export const INTELLIGENCE_CONSOLE_CAPABILITIES: readonly IntelligenceConsoleCapability[] = [
  ...
  {
    capabilityId: 'VISUAL_QA_ENGINE',
    label: 'Visual QA Engine',
    phase: 24.71,
    ownerModule: 'devpulse_v2_visual_qa_engine',
    extensionOnly: true,
  },
  {
    capabilityId: 'UX_HEURISTIC_EVALUATOR',
    label: 'UX Heuristic Evaluator',
    phase: 24.73,
    ownerModule: 'devpulse_v2_ux_heuristic_evaluator',
    extensionOnly: true,
  },
  {
    capabilityId: 'FIRST_IMPRESSION_JUDGE',
    label: 'First-Impression Judge',
    phase: 24.74,
    ownerModule: 'devpulse_v2_first_impression_judge',
    extensionOnly: true,
  },
  {
    capabilityId: 'LIVE_PREVIEW_GATEKEEPER',
    label: 'Live Preview Gatekeeper',
    phase: 24.75,
    ownerModule: 'devpulse_v2_live_preview_gatekeeper',
    extensionOnly: true,
  },
  {
    capabilityId: 'AUTO_POLISH_LOOP',
    label: 'Auto-Polish Loop',
    phase: 24.76,
    ownerModule: 'devpulse_v2_auto_polish_loop',
    extensionOnly: true,
  },
  {
    capabilityId: 'PRODUCT_EXPERIENCE_VERIFICATION_ENGINE',
    label: 'Product Experience Verification Engine',
    phase: 24.77,
    ownerModule: 'devpulse_v2_product_experience_verification_engine',
    extensionOnly: true,
  },
  {
    capabilityId: 'PRODUCT_REALITY_ORCHESTRATOR',
    label: 'Product Reality Orchestrator',
    phase: 24.78,
    ownerModule: 'devpulse_v2_product_reality_orchestrator',
    extensionOnly: true,
  },
  {
    capabilityId: 'FOUNDER_ACCEPTANCE_FRAMEWORK',
    label: 'Founder Acceptance Framework',
    phase: 24.81,
    ownerModule: 'devpulse_v2_founder_acceptance_framework',
    extensionOnly: true,
  },
  {
    capabilityId: 'FOUNDER_WORKFLOW_VALIDATION',
    label: 'Founder Workflow Validation',
    phase: 24.82,
    ownerModule: 'devpulse_v2_founder_workflow_validation',
    extensionOnly: true,
  },
  {
    capabilityId: 'FOUNDER_CONFIDENCE_ENGINE',
    label: 'Founder Confidence Engine',
    phase: 24.83,
    ownerModule: 'devpulse_v2_founder_confidence_engine',
    extensionOnly: true,
  },
  {
    capabilityId: 'FOUNDER_TRUST_VALIDATION',
    label: 'Founder Trust Validation',
    phase: 24.84,
    ownerModule: 'devpulse_v2_founder_trust_validation',
    extensionOnly: true,
  },
  {
    capabilityId: 'FOUNDER_PRODUCTIVITY_VALIDATION',
    label: 'Founder Productivity Validation',
    phase: 24.85,
