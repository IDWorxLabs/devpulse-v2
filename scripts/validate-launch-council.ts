...
function main(): void {
  ...
  assert('02. registered authorities', listLaunchCouncilAuthorities().length === 22, 'count=22');
  ...
  assert('10. founder integration wired', reportBuilder.includes('assembleLaunchCouncilFromFounderTestV4') && reportBuilder.includes('buildClarifyingQuestionIntelligenceArtifacts') && reportBuilder.includes('buildUIReviewerAuthorityArtifacts') && reportBuilder.includes('buildSkepticalFounderSimulatorArtifacts') && reportBuilder.includes('buildPromiseFulfillmentArtifacts') && reportBuilder.includes('buildTrustAuthorityArtifacts') && reportBuilder.includes('buildSelfAwarenessAuthorityArtifacts') && reportBuilder.includes('buildUserSuccessAuthorityArtifacts') && reportBuilder.includes('buildGapDetectionAuthorityArtifacts') && reportBuilder.includes('buildSelfEvolutionAuthorityArtifacts') && reportBuilder.includes('buildUnknownDiscoveryAuthorityArtifacts') && reportBuilder.includes('buildFirstTimeUserRealityAuthorityArtifacts') && reportBuilder.includes('buildCustomerValueAuthorityArtifacts') && reportBuilder.includes('buildCompetitiveRealityAuthorityArtifacts') && reportBuilder.includes('buildRealityProofAuthorityArtifacts') && reportBuilder.includes('buildRealUserRealityAuthorityArtifacts') && reportBuilder.includes('buildAdoptionPredictionAuthorityArtifacts') && reportBuilder.includes('buildLaunchReadinessAuthorityArtifacts'), 'report builder');
