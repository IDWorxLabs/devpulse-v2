...
export default function SettingsFeature() {
  ...
  const headline = useMemo(() => 'Settings for n AI chat — an AI chat app with conversation threads, prompt input, model responses, and chat history sidebar.', []);
