  ...
  return (
    ...
    >
      ...
      <nav className="modular-nav" aria-label="Feature modules">
        ...
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'products' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('products')}
        >
          Products
        </button>
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'cart' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('cart')}
        >
          Cart
        </button>
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'checkout' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('checkout')}
        >
          Checkout
        </button>
        <button
        ...
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'payments' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('payments')}
        >
          Payments
        </button>
      </nav>
