  ...
  return (
    ...
    >
      <nav className="modular-nav" aria-label="Feature modules">
        ...
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'employees' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('employees')}
        >
          Employees
        </button>
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'onboarding' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('onboarding')}
        >
          Onboarding
        </button>
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'time-off' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('time-off')}
        >
          Time Off
        </button>
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'payroll' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('payroll')}
        >
          Payroll
        </button>
      </nav>
