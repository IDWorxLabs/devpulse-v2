...
export default function NotesFeature() {
  ...
  const headline = useMemo(() => 'Notes for reusable components where — a modern, production-quality Restaurant Management Platform for independent restaurants.', []);
    ...
    >
      ...
      <div className="modular-feature-body">
        <article className="modular-feature-card">
          <h3>reusable components where — Notes</h3>
          <p>{headline}</p>
