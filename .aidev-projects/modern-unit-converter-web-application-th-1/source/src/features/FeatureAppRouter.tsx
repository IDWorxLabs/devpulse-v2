  ...
  return (
    ...
    >
      <header className="assistive-app-header" data-communication-board="true">
        <h1>reusable components where</h1>
      ...
      <nav className="modular-nav" aria-label="Feature modules">
        ...
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'revenue' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('revenue')}
        >
          Revenue
        </button>
        <button
        ...
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'orders' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('orders')}
        >
          Orders
        </button>
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'staff' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('staff')}
        >
          Staff
        </button>
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'inventory' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('inventory')}
        >
          Inventory
        </button>
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'taxes' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('taxes')}
        >
          Taxes
        </button>
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'currency' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('currency')}
        >
          Currency
        </button>
      </nav>
