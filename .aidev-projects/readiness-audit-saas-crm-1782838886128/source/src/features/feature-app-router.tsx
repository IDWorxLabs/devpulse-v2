...
export default function FeatureAppRouter() {
  const [activeModuleId, setActiveModuleId] = useState('activities');
  ...
  return (
    ...
    >
      <nav className="modular-nav" aria-label="Feature modules">
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'activities' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('activities')}
        >
          Activities
        </button>
        <button
        ...
        <button
          type="button"
          className={`modular-nav-item ${activeModuleId === 'deals' ? 'is-active' : ''}`}
          onClick={() => setActiveModuleId('deals')}
        >
          Deals
        </button>
        <button
