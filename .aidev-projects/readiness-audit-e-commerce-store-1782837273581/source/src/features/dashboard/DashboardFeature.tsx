...
export default function DashboardFeature() {
  ...
  const headline = useMemo(() => 'Dashboard for Custom App — an e-commerce store with product catalog, shopping cart, checkout flow, and order history pages.', []);
